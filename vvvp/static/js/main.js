...
function describeImage(file){
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      to_text_area(desc_img['text']);
      // $('#img-desc-accuracy').text('Accuracy : '+desc_img['accuracy']+'%');
      desc_text = desc_img['text'];
...
function to_text_area(text){
  document.getElementById("myvalue").value = text;
}
...
function setInputValue(input_id, val) {
    document.getElementById(input_id).value('value', val.text());
}
